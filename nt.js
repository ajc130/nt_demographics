function overlay(id,text,url) {
    ...
    overlay.setAttribute("style", "z-index: 10; background-color: white; position: fixed; left: " + Xpos + "px; top: " + Ypos + "px; border: 2px solid black; width: 300px; padding: 2px; margin: 0;")
